...
public class Main extends JFrame {
	...
	private static Clip baddestEndingMusic;
...
*/
    ...
    String readFile(String filePath) throws IOException {
		...
		public void stopBadMusic(){
			if(badEndingMusic != null && badEndingMusic.isRunning()){
			badEndingMusic.stop();
			badEndingMusic.close();
}
}
		public void stopBaddestMusic(){
			if(baddestEndingMusic != null && baddestEndingMusic.isRunning()){
			baddestEndingMusic.stop();
			baddestEndingMusic.close();
